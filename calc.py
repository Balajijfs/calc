...
def clear():
    input.delete(0,END)
    return
button_1 = Button(root, text="1", padx=50, pady=50, command=lambda:click(1))
button_2 = Button(root, text="2", padx=50, pady=50, command=lambda:click(2))
button_3 = Button(root, text="3", padx=50, pady=50, command=lambda:click(3))
button_4 = Button(root, text="4", padx=50, pady=50, command=lambda:click(4))
button_5 = Button(root, text="5", padx=50, pady=50, command=lambda:click(5))
button_6 = Button(root, text="6", padx=50, pady=50, command=lambda:click(6))
button_7 = Button(root, text="7", padx=50, pady=50, command=lambda:click(7))
button_8 = Button(root, text="8", padx=50, pady=50, command=lambda:click(8))
button_9 = Button(root, text="9", padx=50, pady=50, command=lambda:click(9))
button_0 = Button(root, text="0", padx=50, pady=50, command=lambda:click(0))
button_dot= Button(root, text=".", padx=50, pady=50, command=click)
button_equal = Button(root, text="=", padx=50, pady=50, command=equal)
button_add = Button(root, text="+", padx=50, pady=50, command=add)
button_sub = Button(root, text="-", padx=50, pady=50, command=sub)
button_multi = Button(root, text="*", padx=50, pady=50, command=multi)
button_div = Button(root, text="/", padx=50, pady=50, command=div)
button_clear = Button(root, text="AC", padx=50, pady=50, command=clear)
